public class Fecha {
    ...
    public Fecha(int dia, int mes, int anio) {
        ...
        this.mes = mes;
        this.anio = anio;
        if (!fechaCorrecta(this)) { // En caso de que la fecha sea incorrecta iniciamos al 11-02-2025 por defecto
            this.anio = 2025;
            this.mes = 2;
            this.dia = 11;
        }
    ...
    /**
     * Modificamos el día solo si es correcto, comprobandolo con el año y mes ya existentes en el objeto
     * @param dia
     */
    public void setDia(int dia) {
        if (diaCorrecto(dia, mes, anio)) this.dia = dia;
    }
    ...
    /**
     * Modificamos el mes solo si es correcto
     * @param mes
     */
    public void setMes(int mes) {
        if (mesCorrecto(mes)) this.mes = mes;
    }
    ...
    /**
     * Modificamos el año solo si es correcto
     * @param anio
     */
    public void setAnio(int anio) {
        if (anioCorrecto(anio)) this.anio = anio;
    }
    ...
    private static boolean fechaCorrecta(Fecha fecha) {
